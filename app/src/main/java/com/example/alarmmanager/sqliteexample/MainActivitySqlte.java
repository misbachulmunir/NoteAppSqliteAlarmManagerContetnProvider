...
public class MainActivitySqlte extends AppCompatActivity implements LoadNotesCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_sqlte);
        ...
        fabAdd.setOnClickListener(view -> {
            Intent intent = new Intent(MainActivitySqlte.this, NoteAddUpdateActivity.class);
